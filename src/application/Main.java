...
public class Main extends Application {
	...
	public void start(Stage primaryStage) {
		try {
			...
			String sqlCreateString = "CREATE TABLE IF NOT EXISTS Settings (id SERIAL PRIMARY KEY NOT NULL, alias VARCHAR(30), values VARCHAR(100), CONSTRAINT settings_alias_key UNIQUE (alias))";
